...
using JsonSchemaClassGeneratorTest.ConfigurationSchema;
...
namespace JsonSchemaClassGeneratorTest
{
    ...
    public class Tests
    {
        ...
        [TestCase(arguments: "Zipper/ConfigurationSchema.json")]
        ...
        [Test]
        [TestCase("configuration-schema.simple.json")]
        [TestCase("configuration-schema.full.json")]
        public void DeserialiseConfigurationJson(string jsonFile)
        {
            Assert.DoesNotThrow(() => Configuration.FromJson(ReadJsonConfig(jsonFile)));
        }
    }
}